...
fun PopularScreen(moviesPopularUiState: MoviesPopularUiStateDao,
    ...
    else -> PopularErrorScreen(retryAction)
    }
}
 ...
 */
@Composable
fun PopularResultScreen(photos: String) {
    Box(
...
@Composable
fun PopularErrorScreen(retryAction: () -> Unit) {
    Column(
        modifier = Modifier.fillMaxSize(),
...
fun ResultScreenPreview() {
    PeliculasPopularesTheme {
        PopularResultScreen(stringResource(R.string.placeholder_result))
    }
}
