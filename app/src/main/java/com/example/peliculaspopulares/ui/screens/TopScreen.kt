...
@Composable
fun TopScreen(moviesTopUiState: MoviesTopUiStateDao,
              retryAction: () -> Unit,
              modifier: Modifier,
              /**onMovieClick: (String) -> Unit*/) {

    when (moviesTopUiState) {
        is MoviesTopUiStateDao.Loading -> TopLoadingScreen()
        is MoviesTopUiStateDao.Success -> {
            PhotosTopGridScreen(
                photos = moviesTopUiState.photos,
                /**onMovieClick = {onMovieClick(it)},*/
                modifier = modifier
            )
        }
        else -> TopErrorScreen(retryAction)
    }
}
...
@Composable
fun TopErrorScreen(retryAction: () -> Unit) {
    Column(
        modifier = Modifier.fillMaxSize(),
...
@Composable
fun TopPhotoCard(photo: PeliculasTopDAO,
    //onMovieClick: (String) -> Unit
) {
...
@Composable
fun PhotosTopGridScreen(
    modifier: Modifier,
    photos: List<PeliculasTopDAO>,
    //onMovieClick: (String) -> Unit,
...
@Composable
fun TopResultScreen(photos: String) {
    Box(
