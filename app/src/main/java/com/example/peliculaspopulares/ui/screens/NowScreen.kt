...
@Composable
fun NowScreen(moviesNowUiState: MoviesNowUiStateDao,
              retryAction: () -> Unit,
              modifier: Modifier,
              /**onMovieClick: (String) -> Unit*/) {

    when (moviesNowUiState) {
        is MoviesNowUiStateDao.Loading -> NowLoadingScreen()
        is MoviesNowUiStateDao.Success -> {
            PhotosNowGridScreen(
                photos = moviesNowUiState.photos,
                /**onMovieClick = {onMovieClick(it)},*/
                modifier = modifier
            )
        }
        else -> NowErrorScreen(retryAction)
    }
}
...
@Composable
fun NowErrorScreen(retryAction: () -> Unit) {
    Column(
        modifier = Modifier.fillMaxSize(),
...
@Composable
fun NowPhotoCard(photo: PeliculasNowDAO,
    //onMovieClick: (String) -> Unit
) {
...
@Composable
fun PhotosNowGridScreen(
    modifier: Modifier,
    photos: List<PeliculasNowDAO>,
    //onMovieClick: (String) -> Unit,
...
@Composable
fun NowResultScreen(photos: String) {
    Box(
